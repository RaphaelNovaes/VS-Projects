...
void Engine::update(float dtAsSeconds)
{
	...
	if (m_Playing)
	{
		...
		// Detect collisions and see if character have reached the goal tile
		...
		// Have Thomas and bob turn out of time?
	...
	for (it = m_FireEmitters.begin(); it != m_FireEmitters.end(); it++)
	{
		...
		float posX = (*it).x;
		float posY = (*it).y;
		// is the mitter near the player?
		// Make a 500 pixel retangle around the emitter
