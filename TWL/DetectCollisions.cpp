...
bool Engine::detectCollisions(PlayableCharacter& character)
{
	...
	// Make sure we don't text positions lower than zero
	...
	for (int x = startX; x < endX; x++)
	{
		for (int y = startY; y < endY; y++)
		{
			...
			// Use head as this allows him ton sink a bit
			...
			// More collision detection here once we have learnt about particle effects
	...
	// ALl done, return wheter or not a new level might be required 
	return reachedGoal;
}